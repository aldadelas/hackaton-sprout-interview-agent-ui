...
interface TileLayoutProps {
  chatOpen: boolean;
  /** When false, local camera / screen-share preview is never shown (voice-only UI). */
  showLocalMediaTile?: boolean;
                ...
                ((cameraTrack && isCameraEnabled) ||
                  ...
                  >
                    <VideoTrack
                      ...
                      width={
                        (cameraTrack || screenShareTrack)?.publication
                          .dimensions?.width ?? 0
                      }
                      height={
                        (cameraTrack || screenShareTrack)?.publication
